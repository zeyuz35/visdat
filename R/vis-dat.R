...
#'   plot - if this happens, downsampling the data is recommended, either
#'   looking at the first 1,000 rows or by taking a random sample. This means
#'   that the visualization may differ slightly, but this is preferable to
#'   a blank plot. See example code for suggestions.
#'
#' @examples
#'
#' vis_dat(airquality)
