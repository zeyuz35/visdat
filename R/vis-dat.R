...
#'   by looking at the first 1,000 rows or by taking a random sample. This means
#'   that the resulting plot will not reflect the full dataset, but it is
#'   preferable to a blank plot. See example code for suggestions on doing this.
#'
#' @examples
#'
#' vis_dat(airquality)
