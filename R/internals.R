...
fingerprint <- function(x) {
  # is the data missing?
  # using pre-allocated vector assignment instead of ifelse for better performance
  # and lengths() == 0L for faster list emptiness checks
...
n_miss_col <- function(data, sort = FALSE) {
  # if no list columns
  # using base R vapply for better performance
